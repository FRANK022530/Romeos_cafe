...
<body>
  ...
  <div class="box2">
    ...
    <div class="welcome">
      <img class="barista" src="images/profile.png">
      <h1> Employee Information <br><span>Encompasses essential details about individuals employed by a company, including personal, employment, and administrative data.<br>
      ...
      <table>
        <tr>
          <td>
            ...
            $query = "SELECT * FROM emp_info WHERE name = '$name' ";
            ...
            ?>
              <div class="form-container">
                ...
                <?php echo $row['contact']; ?><br><br><br>
                <label for="sss">SSS No.:</label>
                <?php echo $row['sss']; ?><br>
                <label for="philhealth">PhilHealth No.:</label>
                <?php echo $row['philhealth']; ?><br>
                <label for="pagibig">Pagibig No.:</label>
                <?php echo $row['pagibig']; ?><br><br><br>
                <label for="rate">Rate:</label>
                <?php echo $row['rate']; ?><br>
                <label for="hiredate">Hire Date:</label>
                <?php echo date('Y-m-d', strtotime($row['hiredate'])); ?><br>
              </div>
            <?php
      ...
      <div class="three">
        ...
        <div class="pie">
          <div class="piecon">
            ...
            $query = "SELECT name FROM emp_info WHERE name='$name'";
            $query_run = mysqli_query($conn, $query);
              ...
              <tr>
                ...
                <form action="r_nbi.php" method="POST">
                  <td>
                    ...
                    <input type="checkbox" <?php if (!empty($row['r_nbi'])) echo 'checked'; ?>>
              ...
              <tr>
                ...
                <form action="r_psa.php" method="POST">
                  <td>
                    ...
                    <input type="checkbox" <?php if (!empty($row['r_psa'])) echo 'checked'; ?>>
              ...
              <tr>
                ...
                <form action="r_id.php" method="POST">
                  <td>
                    ...
                    <input type="checkbox" <?php if (!empty($row['r_id'])) echo 'checked'; ?>>
              ...
              <tr>
                ...
                <form action="r_1x1.php" method="POST">
                  <td>
                    ...
                    <input type="checkbox" <?php if (!empty($row['r_1x1'])) echo 'checked'; ?>>
              ...
              <tr>
                ...
                <form action="r_healthCert.php" method="POST">
                  <td>
                    ...
                    <input type="checkbox" <?php if (!empty($row['r_healthCert'])) echo 'checked'; ?>>
