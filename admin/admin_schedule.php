            ...
            <form action="process.php" method="POST">
                ...
                <div class="tables">
                    ...
                    <table class="first">
                        ...
                        <tr>
                            <?php
                            $buttonNames = [" "]; // Array of button names in your desired order
                            ...
                            while ($shift_row = mysqli_fetch_assoc($result)) {
                                ...
                                echo '<input type="hidden" name="mon[]" data-mondatetime="' . $mondate . '" data-names="' . $names . '" value="' . $mondate . ' -  // ' . $names . '" />';


                                // Set the initial value for the value cell as an empty paragraph
                                echo '<p class="valueCell"></p>';
                    ...
                    <table class="firsts">
                        ...
                        <tr>
                            ...
                            while ($shift_row = mysqli_fetch_assoc($result)) {
                                ...
                                echo '<input type="hidden" name="tue[]" data-mondatetime="' . $tuedate . '" data-names="' . $names . '" value="' . $tuedate . ' -  // ' . $names . '" />';
                    ...
                    <table class="firstss">
                        ...
                        <tr>
                            ...
                            while ($shift_row = mysqli_fetch_assoc($result)) {
                                ...
                                $names = $shift_row['name']; // Fetch the 'name' from the current row
                                echo '<input type="button" class="changeValueBtn myButton" data-name="' . $buttonNames[$initialButtonNameIndex] . '" value="' . $buttonNames[$initialButtonNameIndex] . '" onclick="toggleColor(this, ' . $initialButtonNameIndex . ')"/>';
                                echo '<input type="hidden" name="wed[]" data-mondatetime="' . $weddate . '" data-names="' . $names . '" value="' . $weddate . ' -  // ' . $names . '" />';
                    ...
                    <table class="firstsss">
                        ...
                        <tr>
                            ...
                            while ($shift_row = mysqli_fetch_assoc($result)) {
                                ...
                                echo '<input type="hidden" name="thur[]" data-mondatetime="' . $thurdate . '" data-names="' . $names . '" value="' . $thurdate . ' -  // ' . $names . '" />';
                    ...
                    <table class="firstssss">
                        ...
                        <tr>
                            ...
                            while ($shift_row = mysqli_fetch_assoc($result)) {
                                ...
                                echo '<input type="hidden" name="fri[]" data-mondatetime="' . $fridate . '" data-names="' . $names . '" value="' . $fridate . ' -  // ' . $names . '" />';
                    ...
                    <table class="firstsssss">
                        ...
                        <tr>
                            ...
                            while ($shift_row = mysqli_fetch_assoc($result)) {
                                ...
                                echo '<input type="hidden" name="sat[]" data-mondatetime="' . $satdate . '" data-names="' . $names . '" value="' . $satdate . ' -  // ' . $names . '" />';
                    ...
                    <table class="firstssssss">
                        ...
                        <tr>
                            ...
                            while ($shift_row = mysqli_fetch_assoc($result)) {
                                ...
                                echo '<input type="hidden" name="sun[]" data-mondatetime="' . $sundate . '" data-names="' . $names . '" value="' . $sundate . ' -  // ' . $names . '" />';
